...
builder.Services.AddAuthentication(CookieAuthenticationDefaults.AuthenticationScheme)
    .AddCookie(options =>
    {
        options.LoginPath = "/login"; // Перенаправляет сюда неаутентифицированных пользователей
        options.AccessDeniedPath = "/accessdenied"; // Перенаправляет сюда аутентифицированного пользователя, к которого нет прав, можно использовать тот же путь
    });
